...
if __name__ == "__main__":
    ...
    if args['data'] == 'db5':
        ...
        raw_data_path= '/apdcephfs/share_1364275/kaithgao/equidock_toy/equidock_public/DIPS/data/DIPS/interim/pairs-pruned/' ## See utils/partition_dips.py on how to get this data preprocessed.
        split_files_path = '/apdcephfs/share_1364275/kaithgao/equidock_toy/equidock_public/DIPS/data/DIPS/interim/pairs-pruned/'
